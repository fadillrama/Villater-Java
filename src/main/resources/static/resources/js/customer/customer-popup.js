...
function addContactButtonListener(){
    $('.contact-button').click(function(event){
        ...
        let urlEndpoint = `/api/customer/contact/${customerId}`;
...
function populateInputForm({id, companyName, contactPerson, address, city, phone, email}){
...
function addSubmitDeleteButtonListener(){
    $('.delete-dialog button').click(function(event){
        let customerId = $('.delete-dialog .id').val();
